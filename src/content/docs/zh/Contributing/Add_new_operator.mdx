...
1. 在对用的[Backend.cpp](https://github.com/UbiquitousLearning/mllm/blob/main/src/backends/cpu/CPUBackend.cpp#L34)文件中引用CPUAbc.hpp
...
## 添加Op的前端表示
在[express](https://github.com/UbiquitousLearning/mllm/tree/main/src/express)目录下实现Op的前端表示，您可以选择实现为[NetTensor](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/ExpressBase.hpp#L71)的方法或者实现为一个[函数](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/Express.hpp#L21)

### Ⅰ. 实现为[NetTensor](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/ExpressBase.hpp#L71)的方法。 

1. 在[ExpressBase.hpp](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/ExpressBase.hpp)中添加声明
```cpp
...
```
2. 在[ExpressBase.cpp](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/ExpressBase.cpp)中实现函数
```cpp
...
### Ⅱ. 实现为[函数](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/Express.hpp#L21)。

1. 在[Express.hpp](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/Express.hpp)中添加声明
```cpp
NetTensor *_Abc(std::vector<NetTensor *> inputs, int param1, bool param2, string name = "");
```
2. 在[Express.cpp](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/Express.cpp)中实现函数
```cpp
