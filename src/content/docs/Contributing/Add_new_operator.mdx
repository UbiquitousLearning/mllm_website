...
Implement the frontend representation of the Op in the [express](https://github.com/UbiquitousLearning/mllm/tree/main/src/express) directory. You can choose to implement it as a method of [NetTensor](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/ExpressBase.hpp#L71) or as a [function](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/Express.hpp#L21).

### Ⅰ. Implement as a method of [NetTensor](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/ExpressBase.hpp#L71).

1. Add the declaration in [ExpressBase.hpp](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/ExpressBase.hpp)
```cpp
...
```
2. Implement the function in [ExpressBase.cpp](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/ExpressBase.cpp)
```cpp
...
### Ⅱ. Implementation as a [function](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/Express.hpp#L21).

1. Add declaration in [Express.hpp](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/Express.hpp)
```cpp
NetTensor *_Abc(std::vector<NetTensor *> inputs, int param1, bool param2, string name = "");
```
2. Implement the function in [Express.cpp](https://github.com/UbiquitousLearning/mllm/blob/main/src/express/Express.cpp)
```cpp
