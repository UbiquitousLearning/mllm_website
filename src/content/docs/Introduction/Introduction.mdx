...
## Give it a try
mllm provides a series of [example programs](https://github.com/UbiquitousLearning/mllm/tree/main/examples), including the implementation of llama, clip, fuyu, vit, imagebind, and more using the mllm framework. 

In addition, mllm also offers [an example app](https://github.com/lx200916/ChatBotApp) for Android devices, where you can upload models to your phone via adb to experience the effects of different models' inference on mllm.
<style>
{`.demo-video td{
    width: 30%;
    text-align: center;
