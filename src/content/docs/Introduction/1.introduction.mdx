...
**mllm** is an open-source large model edge inference framework, mainly supporting CPU inference on Android devices, and also supports accelerating inference through GPU and NPU methods. Currently, mllm supports the inference of large models like <ins>llama</ins>, <ins>fuyu</ins>, <ins>vit</ins>, <ins>imagebind</ins>, <ins>clip</ins>, etc.
